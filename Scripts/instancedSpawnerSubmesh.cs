...
public class instancedSpawnerSubmesh : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(nSamples + " instances are spawned!");
    }
    ...
    void Update()
    {
        foreach (var meshInstance in instances)
        {
            ...
            Graphics.DrawMeshInstanced(meshInstance.mesh, 1, material, matrices, matrices.Length, meshInstance.props);
            Graphics.DrawMeshInstanced(meshInstance.mesh, 2, material, matrices, matrices.Length, meshInstance.props);
            Graphics.DrawMeshInstanced(meshInstance.mesh, 3, material, matrices, matrices.Length, meshInstance.props);
            Graphics.DrawMeshInstanced(meshInstance.mesh, 4, material, matrices, matrices.Length, meshInstance.props);
            Graphics.DrawMeshInstanced(meshInstance.mesh, 5, material, matrices, matrices.Length, meshInstance.props);
